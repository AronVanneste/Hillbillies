...
public class Log {
	 ...
	 * 		The world in which the log is created
	 * @param position
	 * 		An array of integers, the position where the log is created
	 * 
	 * @post The position of the log will equal the given position
	 * 
	 * @post The world of the log will equal the given world
	 ...
	 * 		The world in which the log is created
	 * @post
	 * 		The world of the log will be the given world
	 * @post
	 * 		The log will be in the log list of the world
	 *@throws IllegalWorldException
	...
	/**
	 * @return Returns true if the given position is within the range of the world of the log else false
	 */
	...
	/**
	 * @return Returns whether or not the log is active (i.e. is without owner and not terminated)
	 */
	 ...
	 * @post
	 * 		The position of the log will be the given position
	 * @throws IllegalArgumentException
	...
	/**
	 * @return Returns the position of the log as a list of doubles
	 */
	 ...
	 * 
	 * @post
	 * 		The log will be without owner
	 * @post 		
	 * 		The owner (unit) will not longer carry this log
	 */
	...
	/**
	 * Applies changes in the world or in the logs status to the boulder
	 * @post
	 * 		If the world of the log is terminated, the log will terminate as well
	 * 		If the log is active, the log will be added to the log list of the world
	 * 		If the log is inactive, the log will be removed from the log list of the world
	 */
	 ...
	 * 
	 * @post
	 * 		The log is terminated. It has no owner and is no longer part of a world
	 */
	 ...
	 * 
	 * @post
	 * 		The log is removed from the log list of its world
	 */
